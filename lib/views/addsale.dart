...
class _AddSaleState extends State<AddSale> {
  ...
  void initState() {
    ...
    // Start Add Sale with a clean cart.
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Stock: ${_formatQuantity(product.currentStock)} ${product.unit}',
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      '${saleController.totalItemsCount} items',
