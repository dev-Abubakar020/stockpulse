...
class PurchaseReport extends GetView<PurchaseReportController> {
    ...
    return CustomScreen(
      ...
      body: Obx(() {
        if (controller.isLoading.value) {
          return Center(
            child: SaleReportShimmer(theme: theme),
          );
        }
            ...
            child: ConstrainedBox(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    CustomFilterTabs(
                      items: const [AppConstants.daily, AppConstants.monthly,AppConstants.custom ],
                      selectedIndex: controller.selectedFilter.value == AppConstants.daily
                          ? 0
                          : controller.selectedFilter.value == AppConstants.monthly
                              ? 1
                              : 2,
                      onChanged: (index) {
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: SummaryCard(
                            title: AppConstants.totalPurchases,
                            value: 'Rs ${controller.totalPurchases.value.toStringAsFixed(0)}',
                            percentage: '${controller.purchasesPercentage.value >= 0 ? '+' : ''}${controller.purchasesPercentage.value.toStringAsFixed(1)}%',
                            positive: controller.purchasesPercentage.value >= 0,
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: SummaryCard(
                            title: AppConstants.averagePurchase,
                            value: 'Rs ${controller.averagePurchase.value.toStringAsFixed(2)}',
                            percentage: '${controller.averagePurchasePercentage.value >= 0 ? '+' : ''}${controller.averagePurchasePercentage.value.toStringAsFixed(1)}%',
                            positive: controller.averagePurchasePercentage.value >= 0,
                        ...
                        Expanded(
                          child: SummaryCard(
                            ...
                            value: controller.formatQuantity(controller.itemsPurchased.value),
                            percentage: '${controller.itemsPurchasedPercentage.value >= 0 ? '+' : ''}${controller.itemsPurchasedPercentage.value.toStringAsFixed(1)}%',
                            positive: controller.itemsPurchasedPercentage.value >= 0,
                    ...
                    _ReportSection(
                      ...
                      child: Column(
                        ...
                        children: [
                          _SectionHeader(
                            title: AppConstants.purchaseOverview,
                            theme: theme,
                          ),
                    ...
                    _ReportSection(
                      ...
                      child: Column(
                        ...
                        children: [
                          _SectionHeader(
                            title: AppConstants.purchaseByCategory,
                            theme: theme,
                          ),
                          const SizedBox(height: AppConstants.spaceLG),
                          if (controller.productPurchases.isEmpty)
                            Padding(
                            ...
                            ...controller.productPurchases.map((catReport) {
                              return Padding(
                    ...
                    _ReportSection(
                      ...
                      child: Column(
                        children: [
                          _SectionHeader(
                            title: AppConstants.recentPurchase,
                          ...
                          if (controller.recentPurchases.isEmpty)
                            ...
                            ...controller.recentPurchases.map((purchase) {
                              return Column(
                                children: [
                                  _SaleItem(
                                    invoice: purchase.purchaseNo.isNotEmpty ? purchase.purchaseNo : 'INV-${purchase.id.substring(0, 6)}',
                                    customer: '${AppConstants.paymentMethodLabel} : ${AppConstants.cashLabel}',
                                    date: DateFormat(AppConstants.dateFormat1).format(purchase.purchaseDate),
                                    items: purchase.status.capitalizeFirst ?? AppConstants.completedLabel,
                                    amount: 'Rs ${purchase.totalAmount.toStringAsFixed(0)}',
                                    theme: theme,
                                  ),
                                  Divider(
...
class _PeriodSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          if (controller.selectedFilter.value != AppConstants.custom)
            IconButton(
          ...
          if (controller.selectedFilter.value != AppConstants.custom && controller.hasNextPeriod)
            IconButton(
...
class _SalesChart extends StatelessWidget {
  final AppThemeHelper theme;
  final List<PurchaseChartData> chartData;
